...
class ApiProviderImpl extends ApiProvider {
  ...
  InteractApi get interact => InteractApiImpl(dio);
}
...
class ApiProviderMock extends ApiProvider {
  ...
  @override
  // TODO: implement interact
  InteractApi get interact => InteractApiMock();
}
